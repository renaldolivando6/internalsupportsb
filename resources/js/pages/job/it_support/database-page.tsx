...
const CopPage: React.FC = () => {
  ...
  const menuItems: MenuItem[] = [
    { id: 1, title: "Tapioka 9500", route: "update-f8", icon: "refresh" },
    { id: 2, title: "Tapioka Outstanding", route: "unpost-cop", icon: "refresh" },
  ];
  ...
  return (
    <AppLayout>
      <Head title="Database Navigation" />
      <div className="bg-gradient-to-b from-gray-50 to-gray-100 min-h-screen">
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-3xl mx-auto">
            <h1 className="text-3xl font-bold text-gray-800 mb-2">Tarik Data Database</h1>
