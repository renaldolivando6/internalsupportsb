...
const CopPage: React.FC = () => {
  ...
  const menuItems: MenuItem[] = [
    {
      ...
      icon: "flag",
      subItems: [
        { name: "by PS", route: "open-flag.ps" },
        { name: "by TF", route: "open-flag.tf" }
      ]
    },
    { id: 2, title: "Update F8", route: "update-f8", icon: "refresh" },
    { id: 3, title: "Unpost COP", route: "unpost-cop", icon: "x-circle" },
    { id: 4, title: "Change Order Date", route: "change-order-date", icon: "calendar" }
  ];
  ...
  return (
    <AppLayout>
      <Head title="COP Navigation" />
      <div className="bg-gradient-to-b from-gray-50 to-gray-100 min-h-screen">
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-3xl mx-auto">
            <h1 className="text-3xl font-bold text-gray-800 mb-2">COP Navigation</h1>
